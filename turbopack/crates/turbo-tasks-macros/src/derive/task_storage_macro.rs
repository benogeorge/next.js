...
/// Generate the `drop_data()` method for TaskStorage.
///
/// This method clears all persistent data-category fields for data-only eviction.
/// It must be generated by the macro because it needs to know which specific inline
/// fields belong to the data category.
